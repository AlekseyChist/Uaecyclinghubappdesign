...
export const mockShops: Shop[] = [
  // ── All tab only (selling platforms) ──
  {
    id: 'cyclingmarket',
    name: 'Cycling Market',
    ...
    linkLabel: 'cycling.market/?country=serbia',
    logo: `${SHOPS_IMG}/CyclingMarket Logo.jfif`,
    tabs: ['all'],
  },
  {
    id: 'cikloberza',
    ...
    linkLabel: '2bike.rs/cikloberza/mali-oglasi',
    logo: `${SHOPS_IMG}/2Bike Logo.png`,
    tabs: ['all'],
  },
  // ── Shops ──
  {
    ...
    location: 'Belgrade, Novi Sad & 8 more',
  ...
  },
  {
    ...
    logo: `${SHOPS_IMG}/BikeSport Logo.png`,
    tabs: ['shops'],
  },
  {
    id: 'decathlon',
    ...
    location: 'Belgrade, Novi Sad & 3 more',
    link: 'https://decathlon.rs',
    linkLabel: 'decathlon.rs',
    logo: `${SHOPS_IMG}/Decathlon Logo.jpg`,
    tabs: ['shops'],
  },
  {
    id: 'dbb',
  ...
  },
  {
    ...
    linkLabel: 'instagram.com/freedombikeshop',
    logo: `${SHOPS_IMG}/Freedom Logo.png`,
    tabs: ['services'],
    isPersonal: true,
  },
  {
  ...
  },
  {
    ...
    linkLabel: 'instagram.com/vne_boli57',
    logo: `${SHOPS_IMG}/Lena & Artur Photo.png`,
    tabs: ['services'],
    isPersonal: true,
  },
  {
    ...
    linkLabel: 'instagram.com/fit_by_antoniopavlovich',
    logo: `${SHOPS_IMG}/Palych Logo.jpg`,
    tabs: ['services'],
    isPersonal: true,
  },
  {
    ...
    description: 'Functional lactate testing for determining your FTP and training zones. A 15% discount for DBB app users.',
    location: 'Belgrade',
    link: 'https://instagram.com/laktat_zona',
    linkLabel: 'instagram.com/laktat_zona',
    logo: `${SHOPS_IMG}/Laktat Zona Logo.png`,
    tabs: ['services'],
  },
  // ── Friends ──
  {
  ...
  },
  {
    ...
    description: 'DBB has been aiding war refugees through Golub Miru since its foundation in 2022. Join the good cause!',
    location: 'Novi Sad',
    link: 'https://golubmiru.com',
    linkLabel: 'golubmiru.com',
    logo: `${SHOPS_IMG}/Golub Miru Logo.jpg`,
    tabs: ['friends'],
  },
];
